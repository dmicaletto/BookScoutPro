      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            <div className="glass-panel p-6 rounded-3xl border-l-4 border-emerald-500 hover:scale-[1.02] transition-transform">
              <div className="flex items-center gap-4 mb-2">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg">Sede Centrale</h3>
                  <p className="text-gray-400 text-sm">Vieni a trovarci di persona</p>
                </div>
              </div>
            ...
            <div className="glass-panel p-6 rounded-3xl border-l-4 border-emerald-500 hover:scale-[1.02] transition-transform">
              <div className="flex items-center gap-4 mb-2">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Scrivici per info o supporto</p>
                </div>
              </div>
              <p className="text-gray-300 ml-14">
                <a href="mailto:info@libreriasottomarina.it" className="text-emerald-400 hover:underline">
            ...
            <div className="glass-panel p-6 rounded-3xl border-l-4 border-emerald-500 hover:scale-[1.02] transition-transform">
              <div className="flex items-center gap-4 mb-2">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg">Orari di Apertura</h3>
                  <p className="text-gray-400 text-sm">Quando siamo aperti</p>
                </div>
              </div>
              <div className="text-gray-300 ml-14 text-sm space-y-1 mt-2">
                ...
                <p className="flex justify-between text-gray-500"><span>Domenica:</span> <span>Chiuso</span></p>
              </div>
            </div>
          </div>
          ...
          <div className="glass-panel p-8 rounded-3xl flex flex-col justify-center items-center text-center h-full min-h-[400px]">
            <div className="w-20 h-20 rounded-full bg-gray-800/50 flex flex-col items-center justify-center text-gray-500 mb-6">
              <Phone size={32} />
            </div>
            <h3 className="text-2xl font-bold text-white mb-4">Hai bisogno di aiuto?</h3>
